              ...
              <div class="col-md-12" id="itembody">
                ...
                <div class="col-md-6">
                  ...
                  <div class="col-md-12" id="sellerinfo">
                    ...
                    <address>
                      <button id="callnow" href="tel:<?php echo $contactno ?>"><i class="fa  fa-phone fa-lg" aria-hidden="true" ></i> Call Now</button>
                      <button id="msgbtn" href="mailto:<?php echo $email ?>"><i class="fa  fa-envelope fa-lg" aria-hidden="true" ></i> Send Message</button>
                    </address>
                  </div>
                </div>
              </div>
