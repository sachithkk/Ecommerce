<?php 
  ...
  $_SESSION["parentpage"] = "Manage Admins";
  $_SESSION["pagetitle"] =  "Add New Admin";
?>
  ...
  if (isset($_POST["submit"])){
    ...
    if ($formError == ""){
     ...
     $password = mysqli_real_escape_string($connection, $password);
      ...
      $query .= "(Name, Username, userPassword, Gender, ContactNo, Email, Country, UserType, ProfileImage) ";
      $query .= "VALUES ('".$name."', '".$username."', '".$passhash."', '".$gender."', '".$contact."', '".$email."', '".$country."', 'Admin','".$pp."' );"; 
    ...
    <div class="container">
        ...
        <div class="col-md-9 col-sm-9 col-xs-12">
           <div class="accountbody">
              <h2 class="col-xs-9"><i class="fa fa-user-secret fa-2x" aria-hidden="true"></i> Add New Admin</h2>
              <div class="clearfix"></div>
          <?php echo $formError ?>
      <form method="POST" action="addnewadmin.php" class="form-group">
        <label>Name</label>
        ...
        <br/>
        <button class="btn btn-primary addbtn" type="submit" name="submit" value="submit">Register New Admin</button>
      </form>
      </div>
    </div>
    </div>
